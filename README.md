__Внимание!__ Этот репозиторий морально и физически устарел и более не поддерживается. Он содержит конспект примерно трети курса, написанный не самым лучшим образом, содержащий ошибки. Не используйте это!
